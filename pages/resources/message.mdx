...
| 1 \<\< 17 | HIDDEN_SUSPENDED_USER                  | Message was sent by a suspended user and is hidden like blocked or spam messages |
...
<RouteHeader
  method="PUT"
  url="/partner-sdk/dms/{user_1.id}/{user_2.id}/messages/{message.id}/moderation-metadata"
  supportsBot
>
