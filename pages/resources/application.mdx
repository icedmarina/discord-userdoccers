...
| categories?^6^                               | [categories](/resources/application-directory#categories-object) object                                                   | Describes the types of things the application does                                                                                                                              |
| directory_entry?^6^                          | [directory entry](/resources/application-directory#directory-entry-object) object                                         | The application directory entry for the [application directory](/resources/application-directory)                                                                               |
| position?^6^                                 | integer                                                                                                                   | The position where the application should appear                                                                                                                                |
...
^6^ Only present when fetched from the [Application Directory](/resources/application-directory) endpoints.
